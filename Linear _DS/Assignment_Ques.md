...
* **Requirements:**
        ...
        1. **Implement Initialization:** Write a function void vector_init(struct MyVector *v, int initial_capacity) that allocates the initial heap memory using malloc.
        1. **Implement Append:** Write int vector_append(struct MyVector *v, int value) that adds elements and automatically doubles the capacity using realloc if the vector fills up.
